          ...
          $sql2 = mysqli_fetch_array($query);
             ...
             else if($amount == 0) 
             {
                 ...
                 echo '</script>';
                  ...
                  $newbalance = $sql1['custamount'] - $amount;
                  $sql = "UPDATE userinfo set custamount=$newbalance where accountno=$from";
                  mysqli_query($con,$sql);
     

        // adding amount to reciever's account
                  $newbalance = $sql2['custamount'] + $amount;
                  $sql= "UPDATE userinfo set custamount = $newbalance where accountno=$to";
                  mysqli_query($con,$sql);
...
<body>
    ...
    <div class="main_heading">
        <center>
            ...
            <p>Click on Transfer Money button to transfer money</p>
        </center>
        <center>
        <div class="container">
